...
import com.ems.EMS_backend.form.EmployeeForm;
import com.ems.EMS_backend.service.EmployeeServiceInt;
...
public class JasperCtl extends BaseCtl<EmployeeForm, EmployeeDTO, EmployeeServiceInt> {
